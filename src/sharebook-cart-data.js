...
class SharebookCartData extends PolymerElement {
  static get template() {
    return html`
    <app-localstorage-document key="sharebook-cart-data" data="{{cart}}"></app-localstorage-document>
`;
  }

  static get is() { return 'sharebook-cart-data'; }
...
customElements.define(SharebookCartData.is, SharebookCartData);
