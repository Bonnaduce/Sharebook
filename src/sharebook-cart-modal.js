...
class SharebookCartModal extends mixinBehaviors(
  ...
  static get template() {
    ...
    <div class="layout-horizontal">
      <sharebook-button class="modal-button">
...
`;
  ...
  static get is() { return 'sharebook-cart-modal'; }
...
customElements.define(SharebookCartModal.is, SharebookCartModal);
