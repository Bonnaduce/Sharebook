...
class SharebookImage extends PolymerElement {
  static get template() {
    return html`
    <style>
...
`;
  ...
  static get is() { return 'sharebook-image'; }
...
customElements.define(SharebookImage.is, SharebookImage);
