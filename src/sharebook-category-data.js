...
let categoryList = [
  {
    name: 'libros_fantasia',
    title: 'Fantas\ía',
    image: 'images/libros_fantasia.jpg',
  ...
  {
    name: 'libros_educativos',
    title: 'Educativos',
    image: 'images/libros_educativos.jpg',
  ...
  },
  {
    name: 'libros_terror',
    title: 'Terror',
    image: 'images/libros_terror.jpg',
...
class SharebookCategoryData extends PolymerElement {

  static get is() { return 'sharebook-category-data'; }
...
customElements.define(SharebookCategoryData.is, SharebookCategoryData);
